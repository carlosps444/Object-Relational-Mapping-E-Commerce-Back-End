...
Product.init(
  {
    // define columns
    id: {
      type: DataTypes.INTGER, // Here it sets the data type to INTEGER
      allowNull: false, // It Disallow's NULL values
      primaryKey: true, // It set as the primary key
    ...
    price: {
      type: DataTypes.DECIMAL, // It sets the data type to DECIMAL
      allowNull: false, // Disallow NULL values
      validate: {
    ...
    stock: {
      type: DataTypes.INTGER, // Set the data type to INTEGER 
      allowNull: false, // Disallow NULL values
